...
from dojo.config_dataclasses.task.active_program_selection import ActiveProgramSelectionTaskConfig
from dojo.utils.binds import is_vtab_active_noprior_task, vtab_active_binds, vtab_active_noprior_binds, vtab_binds
...
def _main(cfg: RunConfig):
    ...
    if isinstance(task_cfg, ActiveProgramSelectionTaskConfig):
        if is_vtab_active_noprior_task(task_cfg):
            ro_binds, rw_binds = vtab_active_noprior_binds(task_cfg)
        else:
            ro_binds, rw_binds = vtab_active_binds(task_cfg)
    else:
        ro_binds, rw_binds = vtab_binds(task_cfg)
